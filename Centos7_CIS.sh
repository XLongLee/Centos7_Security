...
|                         *** SASC WARNING ***                            |
|                                                                         |
| All communication sent using the Company’s networks and computers are   |
| Sykes Assistance Services Corporation’s records. At anytime and without |
| prior notice, management reserves the right to examine and analyze      |
| email, personal file directories, Internet access logs, and other       |
| information stored on the Company’s computers. Such examinations        |
| support external and internal investigations, assure compliance with    |
| various legislative and policy compliance, and assist the management of |
| information systems.                                                    |
| Management of access to information is based on applicable Federal and  |
